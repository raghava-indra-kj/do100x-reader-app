...
import readerDocumentsRouter from "./reader-documents";
...
app.use("/backend-api/workspaces", workspacesRouter);
app.use("/backend-api/reader/documents", readerDocumentsRouter);
