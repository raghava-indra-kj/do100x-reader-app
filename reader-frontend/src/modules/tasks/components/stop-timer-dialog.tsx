      ...
      <div className="w-full max-w-sm bg-[var(--color-surface-raised)] border border-[var(--color-border-default)] rounded-lg shadow-xl overflow-hidden animate-in zoom-in-95 duration-150">
        ...
        <div className="p-4 border-b border-[var(--color-border-subtle)] flex items-center justify-between">
          <div className="flex items-center space-x-2.5">
            ...
            <div>
              <h2 className="text-xs font-bold text-[var(--color-text-strong)]">Record Time Session</h2>
            </div>
          </div>
          <button
            type="button"
        ...
        <div className="p-4 space-y-3 text-xs">
          {/* Elapsed summary */}
          <div className="p-3 rounded-md bg-[var(--color-surface-soft)]/50 border border-[var(--color-border-subtle)] text-center space-y-0.5">
            <span className="text-[var(--color-text-subtle)] uppercase font-bold text-[10px] tracking-wider">
              Session Duration
            </span>
            <div className="text-2xl font-bold font-mono text-[var(--color-text-strong)]">
          ...
          <div className="space-y-1">
            ...
            <textarea
              ...
              placeholder="e.g. Completed Chapter 4 analysis..."
              className="w-full p-2 rounded-md border border-[var(--color-border-default)] bg-[var(--color-surface-canvas)] focus:outline-none focus:ring-1 focus:ring-[var(--color-brand)] text-[var(--color-text-strong)] placeholder:text-[var(--color-text-muted)] transition"
              autoFocus
            />
          </div>
        </div>
