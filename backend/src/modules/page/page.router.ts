...
import { ReparentPageBodySchema } from "./reparent-page.models";
...
router.post("/pages/:id/reparent", authMiddleware, validateReqBody(ReparentPageBodySchema), handleReparentPage);
